...
| 🛠 | **Selezione dei tool da costruire per gli agenti** | Inventario tool (real-time vs storico, write-through, agente che li usa, parametri, vendor). Parte dai dataflows TradingAgents + tool propri | [[system/modules/agents]] |
