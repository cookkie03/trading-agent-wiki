...
→ Dettaglio in [[system/investment/position-sizing]].
...
Valutazioni "a level" con punteggi categorizzati in più punti del sistema: [[_meta/glossario#Conviction Level|conviction]] sul trade, **valutazione del lavoro di ogni agente** (capire cosa migliorare e come), rating degli asset per il disinvestimento. → formalizzata in [[system/investment/rating-scoring]].

### Scheda ticker auto-aggiornante
Un DB dove ogni ticker ha la sua scheda/page con valutazione corrente, che si auto-aggiorna; gli agenti devono distinguere e cancellare le info vecchie/obsolete/confutate. Difficile ma potente. → [[system/orchestration/parallelism-design]] (alternativa B).

### Layer di "valutatori" per ticker
Layer intermedio tra PM e desk: un valutatore per ticker, ognuno in un thread separato, chiama i desk analisti. Parallelismo + isolamento. → [[system/orchestration/parallelism-design]] (alternativa A).
