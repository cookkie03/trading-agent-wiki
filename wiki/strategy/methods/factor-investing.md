...
→ [[system/quant/quant-backtesting]] — il Quant Agent integrerà factor signals come input
→ [[system/foundation/architecture]] — Factor Investigation Agent nel layer Research & Intelligence (post-MVP)
