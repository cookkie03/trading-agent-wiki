---
source: https://docs.datapizza.ai/0.1.0/Guides/Clients/streaming/
---

[ Skip to content ](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/watsonx/#ibm-watsonx)
  ...
  * API Reference  API Reference 
    * Clients  Clients 
      ...
      * Avaiable Clients  Avaiable Clients 
        ...
        * IBM WatsonX  [ IBM WatsonX  ](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/watsonx/) Table of contents 
          * [ Usage example  ](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/watsonx/#usage-example)
    * Agents  Agents 
...
Table of contents 
  * [ Usage example  ](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/watsonx/#usage-example)
  ...
  4. [ Avaiable Clients  ](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/openai/)


# IBM WatsonX

```
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/watsonx/#__codelineno-0-1)pip install datapizza-ai-clients-watsonx
...
```
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/watsonx/#__codelineno-1-1)from datapizza.clients.watsonx import WatsonXClient
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/watsonx/#__codelineno-1-2)
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/watsonx/#__codelineno-1-3)client = WatsonXClient(
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/watsonx/#__codelineno-1-4)    api_key=os.getenv("IBM_API_KEY"),
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/watsonx/#__codelineno-1-5)    url = os.getenv("IBM_ENDPOINT_URL"),
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/watsonx/#__codelineno-1-6)    project_id = os.getenv("IBM_PROJECT_ID"),
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/watsonx/#__codelineno-1-7)    model="meta-llama/llama-3-2-90b-vision-instruct",
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/watsonx/#__codelineno-1-8))
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/watsonx/#__codelineno-1-9)
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/watsonx/#__codelineno-1-10)response = client.invoke("Hello!")
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/watsonx/#__codelineno-1-11)print(response.text)
