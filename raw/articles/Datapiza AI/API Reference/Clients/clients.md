---
source: https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/clients/
---

[ Skip to content ](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/chunk/#chunk)
...
[ datapizza-labs/datapizza-ai  ](https://github.com/datapizza-labs/datapizza-ai "Go to repository")
  ...
  * API Reference  API Reference 
    ...
    * Type  Type 
      ...
      * Chunk  [ Chunk  ](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/chunk/) Table of contents 
        * [ Chunk  ](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/chunk/#datapizza.type.Chunk)
          * [ __init__  ](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/chunk/#datapizza.type.Chunk.__init__)
        * [ Overview  ](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/chunk/#overview)
...
```
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/chunk/#__codelineno-0-1)__init__(id, text, embeddings=None, metadata=None)
...
| --- | --- | --- | --- |  
|  `id`  |  `str`  |  The id of the chunk.  |  _required_  |  
|  `text`  |  `str`  |  The text of the chunk.  |  _required_  |  
...
## Overview
The `Chunk` class represents a unit of text content that has been segmented from a larger document. It's a fundamental data structure in datapizza-ai used throughout the RAG pipeline for text processing, embedding, and retrieval operations. **Serializable** : Can be easily stored and retrieved from databases
