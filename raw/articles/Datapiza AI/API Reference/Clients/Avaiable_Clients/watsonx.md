---
source: https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/watsonx/
---

[ Skip to content ](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/media/#datapizza.type.Media)
...
[ datapizza-labs/datapizza-ai  ](https://github.com/datapizza-labs/datapizza-ai "Go to repository")
  ...
  * API Reference  API Reference 
    ...
    * Type  Type 
      ...
      * Media  [ Media  ](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/media/) Table of contents 
        * [ Media  ](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/media/#datapizza.type.Media)
          * [ __init__  ](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/media/#datapizza.type.Media.__init__)
          * [ to_dict  ](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/media/#datapizza.type.Media.to_dict)
...
Table of contents 
  * [ Media  ](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/media/#datapizza.type.Media)
  ...
  3. [ Type  ](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/block/)
...
```
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/media/#__codelineno-0-1)__init__(
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/media/#__codelineno-0-2)    *,
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/media/#__codelineno-0-3)    extension=None,
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/media/#__codelineno-0-4)    media_type,
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/media/#__codelineno-0-5)    source_type,
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/media/#__codelineno-0-6)    source,
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/media/#__codelineno-0-7)    detail="high"
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/media/#__codelineno-0-8))
...
|  `media_type`  |  `Literal['image', 'video', 'audio', 'pdf']`  |  The type of media. Defaults to "image".  |  _required_  |  
|  `source_type`  |  `Literal['url', 'base64', 'path', 'pil', 'raw']`  |  The source type of the media. Defaults to "url".  |  _required_  |  
|  `source`  |  `Any`  |  The source of the media. Defaults to None.  |  _required_  |  
###  to_dict

```
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Type/media/#__codelineno-0-1)to_dict()
