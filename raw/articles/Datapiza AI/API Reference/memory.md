---
source: https://docs.datapizza.ai/0.1.0/API%20Reference/memory/
---

[ Skip to content ](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/#ollamaembedder)
...
[ datapizza-labs/datapizza-ai  ](https://github.com/datapizza-labs/datapizza-ai "Go to repository")
  ...
  * API Reference  API Reference 
    ...
    * Embedders  Embedders 
      ...
      * OllamaEmbedder  [ OllamaEmbedder  ](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/) Table of contents 
        * [ Usage  ](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/#usage)
...
```
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/#__codelineno-0-1)from datapizza.embedders.openai import OpenAIEmbedder
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/#__codelineno-0-2)
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/#__codelineno-0-3)embedder = OpenAIEmbedder(
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/#__codelineno-0-4)    api_key="",
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/#__codelineno-0-5)    base_url="http://localhost:11434/v1",
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/#__codelineno-0-6))
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/#__codelineno-0-7)
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/#__codelineno-0-8)# Embed a single text
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/#__codelineno-0-9)embedding = embedder.embed("Hello world", model_name="nomic-embed-text")
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/#__codelineno-0-10)
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/#__codelineno-0-11)print(embedding)
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/#__codelineno-0-12)
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/#__codelineno-0-13)# Embed multiple texts
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/#__codelineno-0-14)embeddings = embedder.embed(
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/#__codelineno-0-15)    ["Hello world", "Another text"], model_name="nomic-embed-text"
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/#__codelineno-0-16))
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/#__codelineno-0-17)
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Embedders/ollama_embedder/#__codelineno-0-18)print(embeddings)
