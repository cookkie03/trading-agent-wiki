---
source: https://docs.datapizza.ai/0.1.0/API%20Reference/Type/media/
---

[ Skip to content ](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/AzureOpenai/#azure-openai)
  ...
  * API Reference  API Reference 
    * Clients  Clients 
      ...
      * Avaiable Clients  Avaiable Clients 
        ...
        * Azure Openai  [ Azure Openai  ](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/AzureOpenai/) Table of contents 
          * [ Usage example  ](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/AzureOpenai/#usage-example)
...
```
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/AzureOpenai/#__codelineno-0-1)pip install datapizza-ai-clients-openai
...
```
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/AzureOpenai/#__codelineno-1-1)from datapizza.clients.openai import OpenAIClient
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/AzureOpenai/#__codelineno-1-2)
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/AzureOpenai/#__codelineno-1-3)load_dotenv()
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/AzureOpenai/#__codelineno-1-4)client = OpenAIClient(
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/AzureOpenai/#__codelineno-1-5)    base_url = "https://YOUR-RESOURCE-NAME.openai.azure.com/openai/v1/"
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/AzureOpenai/#__codelineno-1-6)    api_key= "AZURE_OPENAI_API_KEY",
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/AzureOpenai/#__codelineno-1-7)    model="gpt-4o-mini",
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/AzureOpenai/#__codelineno-1-8))
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/AzureOpenai/#__codelineno-1-9)response = client.invoke("Hello!")
[](https://docs.datapizza.ai/0.1.0/API%20Reference/Clients/Avaiable_Clients/AzureOpenai/#__codelineno-1-10)print(response.text)
